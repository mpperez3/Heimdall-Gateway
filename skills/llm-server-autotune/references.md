...
License: MIT
Adapted for LLM Server catalog.json loop, parallel/tensor_split auto-tune, and beellama generic engine fix.

Changes vs base:
- Added LLM Server-specific catalog.json -> config.yaml sync via sync_config_from_server_config_for_startup
